...
// Skinned Transform Shader /////////////////////////////////////////////////////////////////////////////////
// This shader calculates object space positions and optionally normals and binormals for a skinned vertex.
...
// calculate 3 bone skinning matrix
mul R_INDICES.xyz, V_INDICES.xyz, c[C_CONST1].www
mov a0.x, R_INDICES.x
mul R_SKIN_M0, V_WEIGHTS.x, c[a0.x + C_BONE0_M0]
mul R_SKIN_M1, V_WEIGHTS.x, c[a0.x + C_BONE0_M1]
mul R_SKIN_M2, V_WEIGHTS.x, c[a0.x + C_BONE0_M2]

mov a0.x, R_INDICES.y
mad R_SKIN_M0, V_WEIGHTS.y, c[a0.x + C_BONE0_M0], R_SKIN_M0
mad R_SKIN_M1, V_WEIGHTS.y, c[a0.x + C_BONE0_M1], R_SKIN_M1
mad R_SKIN_M2, V_WEIGHTS.y, c[a0.x + C_BONE0_M2], R_SKIN_M2

//R_TEMP.z = 1 - V_WEIGHTS.x - V_WEIGHTS.y
dp4 R_TEMP.z, V_WEIGHTS.xyzw, c[C_CONST0].wwxz
...
dp3 R_BINORMAL_S.x, R_SKIN_M0, R_TEMP
dp3 R_BINORMAL_S.y, R_SKIN_M1, R_TEMP
dp3 R_BINORMAL_S.z, R_SKIN_M2, R_TEMP
mad R_TEMP.xyz, V_BINORMAL_T.xyz, c[C_NORMALTEX_DECOMPRESS].xxx, c[C_NORMALTEX_DECOMPRESS].yyy
dp3 R_BINORMAL_T.x, R_SKIN_M0, R_TEMP
dp3 R_BINORMAL_T.y, R_SKIN_M1, R_TEMP
dp3 R_BINORMAL_T.z, R_SKIN_M2, R_TEMP
